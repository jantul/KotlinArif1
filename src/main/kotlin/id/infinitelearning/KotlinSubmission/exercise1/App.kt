 ...
 */
fun myProfile() {
    val fristName : String = "Muhammad Arif"
    println("My fist Name is : $fristName")

    val lastName : String ="Sirait"
    ...
    println()
    println("status kamu adalah = " + (x && y))
    println("status kamu adalah = " + (x || y))
    println("status kamu adalah = " + (!y))
...
fun main() {
     ...
     *
     */
    groupDetail("Group 4",listOf("6 member", "Infinite Learning", "Productivity"), "Afternoon")
